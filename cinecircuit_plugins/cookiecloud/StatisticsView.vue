...
.cookie-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin:0}.cookie-metric{padding:15px 16px;border:1px solid color-mix(in srgb,var(--cookie-tone) 15%,transparent);border-radius:12px;background:color-mix(in srgb,var(--cookie-tone) 5%,transparent)}.cookie-metric dt{display:flex;align-items:center;justify-content:space-between;gap:8px;color:var(--app-text-secondary);font-size:12px}.cookie-metric dt .v-icon{color:var(--cookie-tone)}.cookie-metric dd{display:flex;align-items:baseline;gap:6px;margin:7px 0 0;color:var(--cookie-tone);font-family:inherit;font-size:24px;font-weight:700;font-variant-numeric:tabular-nums;line-height:1.15}.cookie-metric dd>span{color:var(--app-text-muted);font-size:11px;font-weight:400}
...
@media(max-width:600px){.cc-statistics-header{padding:6px 16px}.cc-statistics-header h2{font-size:16px}.cookie-metrics{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.cookie-schedule{flex-wrap:wrap}}
</style>
