...
.cc-statistics-header>div{flex:1;min-width:0}.cc-statistics-header h2{font-size:18px;margin:0;line-height:1.2}.cc-statistics-header p{font-size:10px;color:var(--app-text-muted);margin:2px 0 0}
