...
const props=defineProps<{modelValue:Record<string,unknown>;disabled?:boolean;request:(path:string,init?:RequestInit)=>Promise<unknown>;cronFieldComponent:Component}>();
