  ...
  <UiDialog :model-value="true" :max-width="1480" width="calc(100vw - 32px)" @update:model-value="(open: boolean) => { if (!open) context.close(); }">
    <UiCard class="maoyan-dialog">
      ...
      <footer class="maoyan-dialog__actions">
        ...
        <UiButton class="maoyan-dialog__config" icon="mdi-cog-outline" variant="flat" aria-label="配置猫眼榜单" title="配置猫眼榜单" @click="context.configure" />
      </footer>
    </UiCard>
  </UiDialog>
</template>
...
.maoyan-dialog__header h2 { margin: 0; font-size: 22px; font-weight: 600; }
