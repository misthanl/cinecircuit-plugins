...
.signin-stat-dialog__header h2{margin:0;font-size:18px}.signin-stat-dialog__header p{margin:4px 0 0;color:var(--app-text-muted);font-size:10px}
...
.signin-stat-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin:0}.signin-stat-metrics>div{padding:15px 16px;border:1px solid var(--app-border-subtle);border-radius:12px;background:var(--app-surface)}.signin-stat-metrics dt{color:var(--app-text-muted);font-size:12px}.signin-stat-metrics dd{margin:7px 0 0;font-size:24px;font-weight:720}
