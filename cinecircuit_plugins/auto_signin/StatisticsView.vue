...
.signin-stat-dialog__content{display:grid;flex:1 1 auto;grid-template-rows:auto minmax(0,1fr);min-height:0;gap:20px;overflow:hidden;padding:22px 24px;background:var(--app-surface-subtle)}
...
@media(max-width:620px){.signin-stat-dialog{height:auto;max-height:min(820px,calc(92svh - env(safe-area-inset-top,0px) - env(safe-area-inset-bottom,0px)));border-radius:16px!important}.signin-stat-dialog__header{padding:6px 16px}.signin-stat-dialog__content{padding:16px}.signin-stat-dialog__header h2{font-size:16px}.signin-stat-metrics{grid-template-columns:1fr 1fr;gap:8px}.metric{gap:8px;padding:13px 11px}.metric__icon{width:25px;height:25px}.metric strong{font-size:22px}.metric p{font-size:10px}.signin-stat-board__header{padding:13px}.signin-stat-dialog__actions{padding:10px 16px}}
