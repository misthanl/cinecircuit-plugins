...
def test_platform_switches_are_followed_by_their_own_limits():
    ...
    assert [field["key"] for field in fields if field["key"].endswith(("_enabled", "_num")) and field["key"] != "web_movie_num"] == [
        "all_enabled", "all_num", "tx_enabled", "tx_num",
        "iqy_enabled", "iqy_num", "mg_enabled", "mg_num", "yk_enabled", "yk_num",
    ]
